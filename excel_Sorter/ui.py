    ...
    def setup_ui(self):
        ...
        try:
            if os.path.exists(icon_path):
                ...
                pil_icon = pil_icon.resize((28, 28), Image.LANCZOS)  # Adjust size for your UI
        ...
        ttk.Button(file_row, text="📂 Browse File", style="Blue.TButton", width=14, command=self.browse_file).grid(
    ...
    def sort_sheets(self):
        ...
        try:
            for idx, path in enumerate(paths, start=1):
                ...
                # Try sorting; catch exceptions so batch continues
                try:
